...
enum { PRIMARY, SECONDARY, NUMPAD, FUNCTION }; // layers
...
KEYMAPS(
  ...
  (___,          Key_1,         Key_2,     Key_3,      Key_4, Key_5, Key_LEDEffectNext,
   ...
   Key_Enter,      Key_F, Key_G, Key_C, Key_R, Key_L, Key_Slash,
                   Key_D, Key_H, Key_T, Key_N, Key_S, Key_Minus,
   M(MACRO_SWITCH_LANGUAGE),   Key_B, Key_M, Key_W, Key_V, Key_Z, Key_Equals,
   Key_RightShift, Key_LeftAlt, Key_Spacebar, Key_RightControl,
   ShiftToLayer(FUNCTION)),
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   Key_Enter,     Key_Y, Key_U, Key_I,     Key_O,         Key_P,         Key_Equals,
                  Key_H, Key_J, Key_K,     Key_L,         Key_Semicolon, Key_Quote,
   M(MACRO_SWITCH_LANGUAGE),  Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   Key_RightShift, Key_LeftAlt, Key_Spacebar, Key_RightControl,
   ShiftToLayer(FUNCTION)),
  ...
  (___,      Key_F1,           Key_F2,        Key_F3,      Key_F4,        Key_F5,           Key_CapsLock,
   ...
   ___, Key_Delete, Key_LeftGui, ___,
   ___,
...
const macro_t *macroAction(uint8_t macroIndex, uint8_t keyState) {
  ...
  case MACRO_SWITCH_LANGUAGE:
    return MACRODOWN(D(LeftShift),  D(LeftAlt), U(LeftAlt), U(LeftShift), Dr(LockLayer(SECONDARY)));
  }
  return MACRO_NONE;
}
